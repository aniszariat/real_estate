                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.update.password')}}" class="forms-sample">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="old_password" id="old_password" autocomplete="off" @error( 'old_password' ) is-invalid @enderror>
                                @error('old_password')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="new_password" id="new_password" autocomplete="off" @error( 'new_password' ) is-invalid @enderror>
                                @error('new_password')
                                <span class="text-danger">{{ $message}}</span>
                                @enderror
                            </div>
